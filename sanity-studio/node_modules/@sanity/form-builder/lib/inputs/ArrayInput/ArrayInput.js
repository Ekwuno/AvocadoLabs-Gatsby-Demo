...
class ArrayInput extends _react.default.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(FieldSetComponent, _extends({
      ...
      type: type,
      ref: this.setElement
    }, uploadProps), /*#__PURE__*/_react.default.createElement("div", null, value && value.length > 0 && this.renderList(), /*#__PURE__*/_react.default.createElement(_functions.default, {
      type: type,
      value: value,
      readOnly: readOnly,
